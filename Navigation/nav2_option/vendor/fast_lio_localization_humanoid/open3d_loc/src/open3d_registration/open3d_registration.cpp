...
namespace pcd_tools
{
        ...
        bool mutual_filter)
    {
        ...
        // NOTE: Open3D >= 0.16 dropped the trailing `seed` parameter from
        // RegistrationRANSACBasedOnFeatureMatching(); this project originally
        // targeted Open3D 0.14.1, which still had it. `seed_` is kept as a
        // parameter of this wrapper for API compatibility but is no longer
        // forwarded (silence unused-parameter warning).
        (void)seed_;
