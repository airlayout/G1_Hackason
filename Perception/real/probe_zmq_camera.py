...
実機用。Perception/sim/probe_zmq_camera.py と中身は同一で、--host と --out-dir の
...
def main() -> int:
    ...
    parser.add_argument("--host", default="192.168.123.164", help="配信元。有線接続時のG1の固定IP。WiFi接続時は実際のIPを指定する")
    ...
    try:
        ...
        for _ in range(args.frames):
            try:
                ...
                if received == 0:
                    print("[エラー] 画像が1枚も届かなかった。G1本体で run_g1_server.py --camera が起動しているか確認する。", flush=True)
                    return 1
